    ...
    for j in range(d):
        ...
        for i in range(a):
            if (c >= b):
                ...
                z = random.randint(1,b-c)
            c = c + z
            y.append(z)
        y.append(random.randint(1,250))
        polyLst.append(list(y))
    for i in range(a):
        value.append(Fraction(random.randint(1,100), random.randint(1,100)))
...
if __name__ == '__main__':    
    ...
    x5.getEstimate()
    x6 = poly_all(28, 7, [(1, 1, 1, 1, 1, 1, 1, 2), (2, 0, 0, 6, 0, 0, 0, 7), (0, 3, 0, 4, 0, 0, 2, 3), (0, 0, 10, 15, 0, 3, 0, 7), (1, 0, 0, 0, 0, 0, 5, 9), (0, 2, 0, 1, 0, 3, 0, 2)], [Fraction(1, 2), Fraction(1, 3), Fraction(1, 4), Fraction(1, 5), Fraction(1, 6), Fraction(1, 7), Fraction(1, 8)], 10)
    x6.getEstimate()
